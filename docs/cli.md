...
Install with `npm install --global @evanston/plankton@latest` (Node.js 22+). Run `plankton --version` to confirm the installed version. See [authentication](authentication.md) for first-time setup.
