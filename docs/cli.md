...
Install with `npm install --global @evanston/plankton@latest` (Node.js 22+). Version 0.3.3 provides the CLI; `plankton --version` confirms the installed version. See [authentication](authentication.md) for first-time setup.
