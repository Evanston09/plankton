...
The CLI is published as `@evanston/plankton`; its API dependency is `@evanston/plankton-core`. Both are public scoped packages. The CLI release is version 0.2.0.
...
```sh
npm publish /tmp/plankton-release/evanston-plankton-core-0.2.0.tgz --access public --tag latest
npm view @evanston/plankton-core@0.2.0 version
npm publish /tmp/plankton-release/evanston-plankton-0.2.0.tgz --access public --tag latest
